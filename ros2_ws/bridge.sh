...
/J2/cmd_vel@geometry_msgs/msg/Twist@gz.msgs.Twist \
/J2/camera/image_raw@sensor_msgs/msg/Image@gz.msgs.Image \
/J2/lidar@sensor_msgs/msg/LaserScan@gz.msgs.LaserScan \
/J2/odom@nav_msgs/msg/Odometry@gz.msgs.Odometry \
